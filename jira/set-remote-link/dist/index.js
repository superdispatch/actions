...
var JiraClient = class extends JiraApi {
  ...
  removeRemoteLink(issueNumber, title2) {
    super.deleteRemoteLink(issueNumber, title2);
  }
...
// jira/set-remote-link/index.ts
var title = (0, import_core.getInput)("title", { required: true });
var url = (0, import_core.getInput)("url", { required: true });
