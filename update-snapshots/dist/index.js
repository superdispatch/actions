...
async function main() {
  ...
  if (exitCode === 0) {
    (0, import_core.info)("Command successfully finished");
    await completeCheck({
      conclusion: "success",
      output: {
...
__name(main, "main");
async function checkoutRepo(branch) {
...
async function createCheck(octokit) {
  ...
  return async (details) => {
    await octokit.rest.checks.update(__spreadValues(__spreadProps(__spreadValues({}, import_github.context.repo), {
